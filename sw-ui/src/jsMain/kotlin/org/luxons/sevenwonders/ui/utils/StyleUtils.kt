...
/**
 * The cubic-bezier() function defines a Cubic Bézier curve.
 *
 ...
 *
 * The x coordinates provided here must be between 0 and 1 (the Bézier curve points should be between the start time
